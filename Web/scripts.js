...
class Login extends Section {
  ...
  init() {
    console.log('Init Login Section');
...
class Signup extends Section {
  ...
  init() {
    console.log('Init Signup Section');
...
class Index extends Section {
  ...
  async init() {
    console.log('Init Index Section');
...
class Presetup extends Section {
  ...
  init() {
    console.log('Init Presetup Section');
...
class Setup extends Section {
  ...
  async init() {
    console.log('Init Setup Section');
...
class Game extends Section {
  ...
  async fetchGame() {
    if (this.game.turn === this.game.player1 || this.game.state === 'FINISHED' || this.game.state === 'CANCELLED') return;
    const game = await API.post('/api/games/getActive', { id: this.id }, true);
    this.game = game;
    this.gameChanged();
  }
